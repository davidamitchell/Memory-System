...
This folder contains the base ontology — the ontology of ontologies.

These are the canonical, foundational definitions for the core concepts used throughout
this knowledge system: things like *ontology*, *concept*, *graph*, *knowledge*, *fact*.
They form the upper meta-model that all domain-specific ontologies build on.

All definition files follow prose format (no YAML front-matter):
```
# ConceptName
**Domain:** <discipline>
---
...
See [`definition_scheme.md`](../definition_scheme.md) for the full schema.
