...
Canonical definitions for terms used in the knowledge and ontology domain of this project.

All definitions are:
- **Domain-bounded** to the domains of *knowledge* and *ontologies*
- **Necessary and sufficient** — each definition states the conditions that are both required and enough for the term to apply
- **Non-circular** — no term is defined using itself
- **Consistent** — no definition contradicts another in this glossary
- **Dual-form** — each entry provides a *conceptual* definition (intensional, what the term means) and an *operational* definition (how to identify or apply it in practice)
