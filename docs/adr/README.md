...
| [0003](0003-ontology-architecture.md) | Ontology Architecture: Upper/Lower Ontologies and Processing Pipeline | superseded |
| [0004](0004-provenance-model-and-control-plane.md) | Provenance Model, Control Plane, and Architectural Principles | accepted |
